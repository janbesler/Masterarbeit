...
\begin{figure}[h!]
    \centering
    \caption{Kelmarsh Turbine #6 power distribution}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{graphs/results/Linear_pred6_analysis.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{graphs/results/Informer_pred6_analysis.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{graphs/results/VanillaTransformer_pred72_analysis.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{graphs/results/eFormer_pred144_analysis.png}
